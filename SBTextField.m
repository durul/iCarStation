...
- (void)setupViewDefaults
{
    ...
    // view frame
    _originalTextFieldFrame = UIEdgeInsetsInsetRect(self.frame, UIEdgeInsetsMake(0.f, 0.f, 2.f, 0.f));
...
- (void)drawRect:(CGRect)aRect
{
    ...
    if (_shouldDrawPlaceholder) {
        ...
        [_cachedPlaceholder drawInRect:CGRectMake(4.f, floorf((self.frame.size.height - self.font.lineHeight) / 2.f), self.frame.size.width, self.frame.size.height)
